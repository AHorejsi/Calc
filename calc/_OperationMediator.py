...
operationDictionary = {(int, "+", int): lambda leftInt, rightInt: leftInt + rightInt,
                             ...
                             (int, "+", Complex): lambda leftInt, rightComplex: Complex(leftInt + rightComplex.real,
                                                                                        rightComplex.imag0),
                             (int, "+", Quaternion): lambda leftInt, rightQuaternion: Quaternion(
                                 leftInt + rightQuaternion.real,
                             ...
                             (float, "+", Complex): lambda leftFloat, rightComplex: Complex(
                                 leftFloat + rightComplex.real,
                                 rightComplex.imag0),
                             (float, "+", Quaternion): lambda leftFloat, rightQuaternion: Quaternion(
                                 leftFloat + rightQuaternion.real,
                                 rightQuaternion.imag0,
                                 rightQuaternion.imag1,
                                 rightQuaternion.imag2),
                             (Complex, "+", int): lambda leftComplex, rightInt: Complex(leftComplex.real + rightInt,
                                                                                        leftComplex.imag0),
                             (Complex, "+", float): lambda leftComplex, rightFloat: Complex(
                                 leftComplex.real + rightFloat,
                                 leftComplex.imag0),
                             ...
                             (Complex, "+", Quaternion): lambda leftComplex, rightQuaternion: Quaternion(
                                 leftComplex.real + rightQuaternion.real,
                                 leftComplex.imag0 + rightQuaternion.imag0,
                                 rightQuaternion.imag1,
                                 rightQuaternion.imag2),
                             (Quaternion, "+", int): lambda leftQuaternion, rightInt: Quaternion(
                                 leftQuaternion.real + rightInt,
                                 leftQuaternion.imag0,
                                 leftQuaternion.imag1,
                                 leftQuaternion.imag2),
                             (Quaternion, "+", float): lambda leftQuaternion, rightComplex: Quaternion(
                                 leftQuaternion.real + rightComplex.real,
                             ...
                             (Quaternion, "+", Complex): lambda leftQuaternion, rightComplex: Quaternion(
                                 leftQuaternion.real + rightComplex.real,
                                 leftQuaternion.imag0 + rightComplex.imag0,
                                 leftQuaternion.imag1, leftQuaternion.imag2),
                             ...
                             (Quaternion, "-", int): lambda leftQuaternion, rightInt: Quaternion(
                                 ...
                                 leftQuaternion.imag1,
                                 leftQuaternion.imag2),
                             (Quaternion, "-", float): lambda leftQuaternion, rightFloat: Quaternion(
                                 leftQuaternion.real - rightFloat,
                                 leftQuaternion.imag0,
                                 leftQuaternion.imag1,
                                 leftQuaternion.imag2),
                             (Quaternion, "-", Complex): lambda leftQuaternion, rightComplex: Quaternion(
